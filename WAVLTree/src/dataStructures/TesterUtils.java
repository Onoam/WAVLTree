...
public class TesterUtils {
    ...
    public static void printStatus(SuccessStatus[] success, int actualOperations, int wavlOperations, boolean verbose) {
        ...
        System.out.println("== Exceptions occured in cases: " + exceptionList);
        if (verbose) {
            System.out.println("== The following cases passed: " + passedList);
            System.out.println("== The following cases failed: " + failedList);

            System.out.println("==");
            System.out.println("== The reference tree did " + actualOperations + " operations.");
            System.out.println("== The tested tree did " + wavlOperations + " operations.");

        }
        System.out.println("== The operations difference is " + (actualOperations-wavlOperations+0.0)/actualOperations);
        System.out.println("============================================");
